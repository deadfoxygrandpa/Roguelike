...
Elm.Transform2D.make = function (_elm)
                       {
                         ...
                         _elm.Transform2D.values = {_op: _op, translation: translation, scaleY: scaleY, scaleX: scaleX, scale: scale, rotation: rotation, multiply: multiply, matrix: matrix, identity: identity};
                         return _elm.Transform2D.values;
...
Elm.Trampoline.make = function (_elm)
                      {
                        ...
                        _elm.Trampoline.values = {_op: _op, Done: Done, Continue: Continue, trampoline: trampoline};
                        return _elm.Trampoline.values;
                      };Elm.Touch = Elm.Touch || {};
Elm.Touch.make = function (_elm)
                 {
                   ...
                   _elm.Touch.values = {_op: _op, touches: touches, taps: taps};
                   return _elm.Touch.values;
                 };Elm.Time = Elm.Time || {};
...
Elm.Text.make = function (_elm)
                {
                  ...
                  var Text = {ctor: "Text"};
                  _elm.Text.values = {_op: _op, Text: Text, Under: Under, Over: Over, Through: Through, defaultStyle: defaultStyle, toText: toText, style: style, typeface: typeface, monospace: monospace, link: link, height: height, color: color, bold: bold, italic: italic, line: line, leftAligned: leftAligned, rightAligned: rightAligned, centered: centered, justified: justified, plainText: plainText, markdown: markdown, asText: asText};
                  return _elm.Text.values;
...
Elm.Signal.make = function (_elm)
                  {
                    ...
                    _elm.Signal.values = {_op: _op, Signal: Signal, constant: constant, lift: lift, lift2: lift2, lift3: lift3, lift4: lift4, lift5: lift5, lift6: lift6, lift7: lift7, lift8: lift8, foldp: foldp, merge: merge, merges: merges, combine: combine, count: count, countIf: countIf, keepIf: keepIf, dropIf: dropIf, keepWhen: keepWhen, dropWhen: dropWhen, dropRepeats: dropRepeats, sampleOn: sampleOn};
                    return _elm.Signal.values;
                  };Elm.Set = Elm.Set || {};
Elm.Set.make = function (_elm)
               {
                 ...
                 _elm.Set.values = {_op: _op, union: union, toList: toList, singleton: singleton, remove: remove, partition: partition, member: member, map: map, intersect: intersect, insert: insert, fromList: fromList, foldr: foldr, foldl: foldl, filter: filter, empty: empty, diff: diff};
                 return _elm.Set.values;
               };Elm.Regex = Elm.Regex || {};
Elm.Regex.make = function (_elm)
                 {
                   ...
                   _elm.Regex.values = {_op: _op, Regex: Regex, escape: escape, regex: regex, caseInsensitive: caseInsensitive, contains: contains, All: All, AtMost: AtMost, find: find, replace: replace, split: split};
                   return _elm.Regex.values;
...
Elm.Maybe.make = function (_elm)
                 {
                   ...
                   _elm.Maybe.values = {_op: _op, Just: Just, Nothing: Nothing, maybe: maybe, justs: justs, isNothing: isNothing, isJust: isJust};
                   return _elm.Maybe.values;
                 };Elm.List = Elm.List || {};
                                                             ...
                                                             return function ()
                                                                    {
                                                                      ...
                                                                      {case
                                                                       "_Tuple2" :
                                                                         return pred(x) ? {ctor: "_Tuple2", _0: A2(_op["::"],
                                                                                                                   x,
                                                                                                                   _v1._0), _1: _v1._1} : {ctor: "_Tuple2", _0: _v1._0, _1: A2(_op["::"],
                                                                                                                                                                               x,
                                                                                                                                                                               _v1._1)};}
                                                                      _E.Case($moduleName,
...
Elm.Json.make = function (_elm)
                {
                  ...
                  _elm.Json.values = {_op: _op, String: String, Number: Number, Boolean: Boolean, Null: Null, Array: Array, Object: Object, toString: toString, fromString: fromString};
                  return _elm.Json.values;
                };Elm.Http = Elm.Http || {};
Elm.Http.make = function (_elm)
                {
                  ...
                  _elm.Http.values = {_op: _op, Success: Success, Waiting: Waiting, Failure: Failure, request: request, get: get, post: post, send: send, sendGet: sendGet};
                  return _elm.Http.values;
...
Elm.Either.make = function (_elm)
                  {
                    ...
                    var _op = {},
                        ...
                        $moduleName = "Either",
                        $List = Elm.List.make(_elm);
                    var consEither = F2(function (e,_v0)
                                        {
                                          return function ()
                                                 {
                                                   switch (_v0.ctor)
                                                      ...
                                                      return function ()
                                                             {
                                                               ...
                                                               {case
                                                                "Left" :
                                                                  return {ctor: "_Tuple2", _0: A2($List._op["::"],
                                                                                                  e._0,
                                                                                                  _v0._0), _1: _v0._1};
                                                                case
                                                                "Right" :
                                                                  return {ctor: "_Tuple2", _0: _v0._0, _1: A2($List._op["::"],
                                                                                                              e._0,
                                                                                                              _v0._1)};}
                                                               _E.Case($moduleName,
                                                                       "between lines 89 and 91");
                                                             }();}
                                                   _E.Case($moduleName,"between lines 89 and 91");
                                                 }();
                                        });
                                         ...
                                         return function ()
                                                {
                                                  ...
                                                  {case
                                                   ...
                                                   case
                                                   "Right" :
                                                     return A2($List._op["::"],e._0,vs);}
                                                  _E.Case($moduleName,"between lines 84 and 86");
                                                }();
                                       });
                                        ...
                                        return function ()
                                               {
                                                 ...
                                                 {case
                                                  ...
                                                  "Right" :
                                                    return vs;}
                                                 _E.Case($moduleName,"between lines 79 and 81");
                                               }();
                                      });
                                      ...
                                      return function ()
                                             {
                                               ...
                                               {case
                                                ...
                                                "Right" :
                                                  return g(e._0);}
                                               _E.Case($moduleName,"on line 38, column 16 to 60");
                                             }();
                                    });
                    ...
                    _elm.Either.values = {_op: _op, Left: Left, Right: Right, either: either, isLeft: isLeft, isRight: isRight, lefts: lefts, rights: rights, partition: partition, consLeft: consLeft, consRight: consRight, consEither: consEither};
                    return _elm.Either.values;
                  };Elm.Dict = Elm.Dict || {};
Elm.Dict.make = function (_elm)
                {
                                            ...
                                            {case
                                             ...
                                             "RBNode" :
                                               return A3(foldr,
                                                         ...
                                                         t._3);}
                                            _E.Case($moduleName,"between lines 362 and 367");
                                          }();
                                 });
                  var keys = function (t)
                             {
                                            ...
                                            {case
                                             ...
                                             "RBNode" :
                                               return A3(foldl,
                                                         ...
                                                         t._4);}
                                            _E.Case($moduleName,"between lines 354 and 359");
                                          }();
                                 });
                                   ...
                                   return function ()
                                          {
                                            ...
                                            {case
                                             ...
                                             "Same" :
                                               return "Same";}
                                            _E.Case($moduleName,"between lines 180 and 185");
                                          }();
                                 };
                  var Same = {ctor: "Same"};
                                       ...
                                       return function ()
                                              {
                                                ...
                                                _E.Case($moduleName,"between lines 146 and 154");
                                              }();
                                     });
                                       ...
                                       return function ()
                                              {
                                                ...
                                                _E.Case($moduleName,"between lines 124 and 143");
                                              }();
                                     });
                                 ...
                                 return function ()
                                        {
                                          ...
                                          {case
                                           ...
                                           "RBNode" :
                                             return function ()
                                                    {
                                                      var _v45 = A2($Native$Utils.compare,k,t._1);
                                                      switch (_v45.ctor)
                                                      {case
                                                       "EQ" :
                                          ...
                                          _E.Case($moduleName,"between lines 105 and 121");
                                        }();
                               });
                              ...
                              return function ()
                                     {
                                       ...
                                       {case
                                        ...
                                        "RBNode" :
                                          ...
                                          return max(t._4);}
                                       _E.Case($moduleName,"between lines 85 and 102");
                                     }();
                            };
                  var min = function (t)
                            {
                                        ...
                                        "RBNode" :
                                          ...
                                          {case
                                           "RBEmpty" :
                                             ...
                                             break;}
                                          return min(t._3);}
                                       _E.Case($moduleName,"between lines 78 and 81");
                                     }();
                            };
                                          ...
                                          {case
                                           ...
                                           "RBNode" :
                                             return A5(RBNode,
                                                       ...
                                                       A2(map,f,t._3),
                                                       A2(map,f,t._4));}
                                          _E.Case($moduleName,"between lines 346 and 351");
                                        }();
                               });
                                     ...
                                     return function ()
                                            {
                                              ...
                                              {case
                                               ...
                                               "Red" :
                                                 return "Red";}
                                              _E.Case($moduleName,"between lines 54 and 58");
                                            }();
                                   };
                                                      ...
                                                      {case
                                                       ...
                                                       "Red" :
                                                         return A5(RBNode,
                                                                   ...
                                                                   t._4);}
                                                      break;}
                                                   _E.Case($moduleName,"between lines 161 and 167");
                                                 }();
                                        };
                                   ...
                                   return function ()
                                          {
                                            ...
                                            _E.Case($moduleName,"between lines 297 and 299");
                                          }();
                                 };
                                  ...
                                  return function ()
                                         {
                                           ...
                                           _E.Case($moduleName,"between lines 333 and 335");
                                         }();
                                };
                  var Red = {ctor: "Red"};
                                    ...
                                    return function ()
                                           {
                                             ...
                                             {case
                                              ...
                                              "Red" :
                                                return Black;}
                                             _E.Case($moduleName,"between lines 223 and 227");
                                           }();
                                  };
                                    ...
                                    return function ()
                                           {
                                             ...
                                             {case
                                              ...
                                              "Red" :
                                                return NBlack;}
                                             _E.Case($moduleName,"between lines 230 and 234");
                                           }();
                                  };
                                                 ...
                                                 {case
                                                  ...
                                                  "RBNode" :
                                                    return A5(RBNode,
                                                              ...
                                                              t._3,
                                                              t._4);}
                                                 _E.Case($moduleName,"between lines 237 and 239");
                                               }();
                                      };
                                 ...
                                 return function ()
                                        {
                                          ...
                                          _E.Case($moduleName,"between lines 339 and 343");
                                        }();
                               };
                                                  ...
                                                  "RBNode" :
                                                    return A5(bubble,
                                                              ...
                                                              A5(remove_max,
                                                                 ...
                                                                 r._3,
                                                                 r._4));}
                                                 _E.Case($moduleName,"between lines 285 and 288");
                                               }();
                                      });
                                           ...
                                           "_Tuple2" :
                                             ...
                                             {case
                                              ...
                                              "RBNode" :
                                                ...
                                                break;}
                                             break;}
                                          _E.Case($moduleName,"between lines 257 and 275");
                                        }();
                               });
                  ...
                  _elm.Dict.values = {_op: _op, values: values, update: update, union: union, toList: toList, singleton: singleton, remove: remove, partition: partition, member: member, map: map, keys: keys, intersect: intersect, insert: insert, getOrFail: getOrFail, getOrElse: getOrElse, get: get, fromList: fromList, foldr: foldr, foldl: foldl, filter: filter, empty: empty, diff: diff};
                  return _elm.Dict.values;
                };Elm.Debug = Elm.Debug || {};
Elm.Debug.make = function (_elm)
                 {
                   ...
                   _elm.Debug.values = {_op: _op, log: log, crash: crash};
                   return _elm.Debug.values;
                 };Elm.Date = Elm.Date || {};
Elm.Date.make = function (_elm)
                {
                  ...
                  var Mon = {ctor: "Mon"};
                  var Date = {ctor: "Date"};
                  _elm.Date.values = {_op: _op, Date: Date, Mon: Mon, Tue: Tue, Wed: Wed, Thu: Thu, Fri: Fri, Sat: Sat, Sun: Sun, Jan: Jan, Feb: Feb, Mar: Mar, Apr: Apr, May: May, Jun: Jun, Jul: Jul, Aug: Aug, Sep: Sep, Oct: Oct, Nov: Nov, Dec: Dec, read: read, toTime: toTime, fromTime: fromTime, year: year, month: month, day: day, dayOfWeek: dayOfWeek, hour: hour, minute: minute, second: second};
                  return _elm.Date.values;
                };Elm.Color = Elm.Color || {};
Elm.Color.make = function (_elm)
                 {
                   ...
                   _elm.Color.values = {_op: _op, RGBA: RGBA, HSLA: HSLA, rgba: rgba, rgb: rgb, hsla: hsla, hsl: hsl, grayscale: grayscale, greyscale: greyscale, complement: complement, toHsl: toHsl, toRgb: toRgb, fmod: fmod, rgbToHsl: rgbToHsl, hslToRgb: hslToRgb, Linear: Linear, Radial: Radial, linear: linear, radial: radial, lightRed: lightRed, red: red, darkRed: darkRed, lightOrange: lightOrange, orange: orange, darkOrange: darkOrange, lightYellow: lightYellow, yellow: yellow, darkYellow: darkYellow, lightGreen: lightGreen, green: green, darkGreen: darkGreen, lightBlue: lightBlue, blue: blue, darkBlue: darkBlue, lightPurple: lightPurple, purple: purple, darkPurple: darkPurple, lightBrown: lightBrown, brown: brown, darkBrown: darkBrown, black: black, white: white, lightGrey: lightGrey, grey: grey, darkGrey: darkGrey, lightGray: lightGray, gray: gray, darkGray: darkGray, lightCharcoal: lightCharcoal, charcoal: charcoal, darkCharcoal: darkCharcoal};
                   return _elm.Color.values;
                 };Elm.Char = Elm.Char || {};
...
Elm.JavaScript.Experimental.make = function (_elm)
                                   {
                                     ...
                                     _elm.JavaScript.Experimental.values = {_op: _op, RawObject: RawObject, toRecord: toRecord, fromRecord: fromRecord, toJson: toJson, fromJson: fromJson};
                                     return _elm.JavaScript.Experimental.values;
...
Elm.Graphics.Input.make = function (_elm)
                          {
                            ...
                            _elm.Graphics.Input.values = {_op: _op, Handle: Handle, input: input, button: button, customButton: customButton, checkbox: checkbox, dropDown: dropDown, hoverable: hoverable, clickable: clickable};
                            return _elm.Graphics.Input.values;
                          };Elm.Graphics = Elm.Graphics || {};
...
Elm.Graphics.Element.make = function (_elm)
                            {
                              ...
                              _elm.Graphics.Element.values = {_op: _op, empty: empty, widthOf: widthOf, heightOf: heightOf, sizeOf: sizeOf, width: width, height: height, size: size, opacity: opacity, color: color, tag: tag, link: link, newElement: newElement, Image: Image, Container: Container, Flow: Flow, Spacer: Spacer, RawHtml: RawHtml, Custom: Custom, Plain: Plain, Fitted: Fitted, Cropped: Cropped, Tiled: Tiled, image: image, fittedImage: fittedImage, croppedImage: croppedImage, tiledImage: tiledImage, P: P, Z: Z, N: N, Absolute: Absolute, Relative: Relative, container: container, spacer: spacer, DUp: DUp, DDown: DDown, DLeft: DLeft, DRight: DRight, DIn: DIn, DOut: DOut, flow: flow, above: above, below: below, beside: beside, layers: layers, absolute: absolute, relative: relative, middle: middle, topLeft: topLeft, topRight: topRight, bottomLeft: bottomLeft, bottomRight: bottomRight, midLeft: midLeft, midRight: midRight, midTop: midTop, midBottom: midBottom, middleAt: middleAt, topLeftAt: topLeftAt, topRightAt: topRightAt, bottomLeftAt: bottomLeftAt, bottomRightAt: bottomRightAt, midLeftAt: midLeftAt, midRightAt: midRightAt, midTopAt: midTopAt, midBottomAt: midBottomAt, up: up, down: down, left: left, right: right, inward: inward, outward: outward};
                              return _elm.Graphics.Element.values;
                            };Elm.Graphics = Elm.Graphics || {};
...
Elm.Graphics.Collage.make = function (_elm)
                            {
                              ...
                              _elm.Graphics.Collage.values = {_op: _op, Solid: Solid, Texture: Texture, Grad: Grad, Flat: Flat, Round: Round, Padded: Padded, Smooth: Smooth, Sharp: Sharp, Clipped: Clipped, defaultLine: defaultLine, solid: solid, dashed: dashed, dotted: dotted, FPath: FPath, FShape: FShape, FImage: FImage, FElement: FElement, FGroup: FGroup, form: form, fill: fill, filled: filled, textured: textured, gradient: gradient, outlined: outlined, traced: traced, sprite: sprite, toForm: toForm, group: group, groupTransform: groupTransform, move: move, moveX: moveX, moveY: moveY, scale: scale, rotate: rotate, alpha: alpha, collage: collage, path: path, segment: segment, polygon: polygon, rect: rect, square: square, oval: oval, circle: circle, ngon: ngon};
                              return _elm.Graphics.Collage.values;
                            };Elm.Graphics = Elm.Graphics || {};
Elm.Graphics.Input = Elm.Graphics.Input || {};
...
Elm.Graphics.Input.Field.make = function (_elm)
                                {
                                  ...
                                  _elm.Graphics.Input.Field.values = {_op: _op, uniformly: uniformly, noOutline: noOutline, noHighlight: noHighlight, defaultStyle: defaultStyle, Forward: Forward, Backward: Backward, noContent: noContent, field: field, password: password, email: email};
                                  return _elm.Graphics.Input.Field.values;
                                };
(function() {
'use strict';
